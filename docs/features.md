...
- **Production homepage** — landing page, recent/popular pascos
- **Enriched pasco display** — course code/title on cards and detail (API currently returns `courseId` only)
